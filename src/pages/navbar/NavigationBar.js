...
function NavigationBar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // If scrolled beyond 50px from top, set scrolled state to true
      if (!isTop) {
        setScrolled(true);
      } else {
        setScrolled(false);
        ...
        <div className='container'>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-aut">
              ...
              >
                <Link className='dropdown-item' to="/allcourse">Courses</Link>
                <Link className='dropdown-item' to="/upcomingcourse">Upcoming Batches</Link>
              </NavDropdown>
